    ...
    public partial class Form1 : Form
    {
        ...
        public void WorkingThread()
        {
            try
            {
                ...
                {
                    log("sử dụng cookie đăng nhập vào tài khoản");
                ...
                {
                    log(AccountPredictionTB.Text + " là Facebook thật");
                }
                driver.Dispose();
        ...
        {
            log("Training....");
            prediction.traning(TraningExamplesPathTB.Text);
            log("Done!");
